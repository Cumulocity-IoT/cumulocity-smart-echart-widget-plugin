...
# Cumulocity Smart Echart Widget Plugin [<img width="35" src="https://user-images.githubusercontent.com/32765455/211497905-561e9197-18b9-43d5-a023-071d3635f4eb.png"/>](https://github.com/Cumulocity-IoT/cumulocity-smart-echart-widget-plugin/releases/download/1.0.3/sag-ps-pkg-smart-echart-1.0.3.zip)
...
* This widget support runtime deployment. Download [Runtime Binary](https://github.com/Cumulocity-IoT/cumulocity-smart-echart-widget-plugin/releases/download/1.0.3/sag-ps-pkg-smart-echart-1.0.3.zip) and install via Administrations --> Ecosystems --> Applications --> Packages 
